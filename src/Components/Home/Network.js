...
import image2  from '../../images/gallery/xebia2.jpg';
import image3  from '../../images/gallery/xebia3.jpg';
import image4  from '../../images/gallery/xebia4.jpg';
import image5  from '../../images/gallery/xebia5.jpg';
        ...
        <div className="container">
          <div className="row">
            <div className="col" data-zanim-timeline="{}">
              <h2 className="mb-5 font-weight-bold text-transform-none text-center" data-zanim-xs="{'duration':'1.5','delay':0.1}" style={{opacity: 1, transform: 'matrix(1, 0, 0, 1, 0, 0)'}}>Our Network</h2>
            </div>
          </div>
          <div className="row">
