...
const AboutUs = () => {
    return (
        ...
        <div className="container mb-5">
          <div className="col">
          <marquee className="sliding-text">Welcome to Xebia's community of Alumni , Create lasting and lifelong relationships by joining our Alumni community.</marquee>
          </div>
        </div>
